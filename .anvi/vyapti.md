...
### V32: Every editor-only viewport object carries `userData.editorChrome === true`; an image render shows DAG content ONLY (chrome is excluded by the render's hide-pass)
...
### V33: Every user-triggered fallible or degradable action surfaces its outcome — no silent no-op
