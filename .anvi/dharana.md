...
**REF:** issues #160 + #162, hetvabhasa [[H40]] (#160 grab-side + #162 selection-side extensions), [[B1.1]] (the value-leak sibling), `src/app/animate/resolveEditTarget.ts`, `src/viewport/SceneFromDAG.tsx` (onClick unwrap), `src/app/NPanel.tsx:736-741`, `tests/e2e/p160-gizmo-layer-select.spec.ts`, `tests/e2e/p162-layer-select-unwrap.spec.ts`, `~/.anvideck/projects/basher/ref/GROUND_TRUTH_BLENDER_KEYING.md` (Blender model), Houdini parms/animlayer docs (sidefx.com). PR #161.
