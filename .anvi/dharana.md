...
REF: `.planning/phases/v06.2-material-texture-editing/{CONTEXT,RESEARCH,PLAN,VERIFICATION}.md` (D-01..D-07, 8-wave plan, R1-R6, checker PASS-WITH-CAVEATS); [[V32]] (the IR-is-compile-target invariant), DCC-reference §11a (OpenPBR grounding), [[V29]] (one EvaluatedMesh face), [[V10]]/[[H14]] (migration guard), [[V20]]/[[H36]] (single writer), [[V28]]/[[H59]] (override + map-aware), [[H40]] (boundary-pair), [[B1.1]]/[[B14]] (the resolver/transient lineage this reuses); memory `project_material_architecture.md`; THESIS §58/§59/§741/§747. Issue: to be filed (`v0.6 #2 — Material + texture editing UI`).
