...
export const GOLDEN_PARAM_HOMES: Readonly<Record<string, string>> = {
  ...
  AnimationClip:
    '[animate] name=(unrouted) duration=(unrouted) loop=(unrouted) active=(unrouted) keyframes=(unrouted)',
...
export const GOLDEN_TOTALS = { types: 83, routed: 135, unrouted: 220 } as const;
