...
const formatMigrations: Record<number, FormatMigration> = {
  ...
  // v10 → v11 (#930): one vocabulary for what a clip does past its last key.
...
/**
 * v10 → v11 (#930) — the clip `loop` becomes one tri-state vocabulary.
 *
